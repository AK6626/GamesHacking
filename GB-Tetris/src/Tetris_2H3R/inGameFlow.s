...
; combine 4 inc to 1 add to get 2 spaces for code below
    add  a, $4                                                   ; $204a 4b
    cp   $1c                                                     ; $204c 4d
    jr   z, .xorAloop                                            ; $204e 4f
...
; hidden random val to go into loaded piece
    ldh  a, [hHiddenLoadedPiece]                                 ; $2053 54
    ld   e, a                                                    ; $2055
    dec  h                                                       ; $2056
    jr   z, .hDone                                               ; $2057 58
...
; curr random val -> last random val
	...
	ld   a, d                                                    ; $2059
; c is current, a and d is the next to preview, e is preview
; if a is same as c or e,  rerandom
	cp   e                                                       ; $205a
	and  $fc                                                     ; $205b 5c
	jr   z, .upToDIV                                             ; $205d 5e
	cp   c                                                       ; $205f
    jr   z, .upToDIV                                             ; $2060
